...
int kvm_set_apic_base(struct kvm_vcpu *vcpu, struct msr_data *msr_info)
{
	...
	if (kvm_x86_ops.set_xapic_disable && 
		static_call(kvm_x86_set_xapic_disable)(vcpu, msr_info->data))
		return 1;
...
static int kvm_emulate_msr_read_with_filter(struct kvm_vcpu *vcpu, u32 index, u64 *data)
{
...
static int kvm_emulate_msr_write_with_filter(struct kvm_vcpu *vcpu, u32 index, u64 data)
{
...
EXPORT_SYMBOL_GPL(kvm_emulate_wbinvd_noskip);
